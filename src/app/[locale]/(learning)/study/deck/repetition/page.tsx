import DeckSpacedRepetition from '@/components/RepetitionGround/DeckRepetition'
import React, { Suspense } from 'react'

const DeckRepetitionPage = () => {
  return (
    <div>
...
export default DeckRepetitionPage