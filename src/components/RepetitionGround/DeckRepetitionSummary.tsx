...
const DeckRepetitionSummary: React.FC<Props> = ({ cardData, trackedData }) => {
    ...
    const grouped = useMemo(() => {
        ...
        trackedData.forEach((entry) => {
            const cardId = isReviewMode ? entry.updatedCard.updatedCard.card_id || 0 : entry.updatedCard.updatedCard.id;
    ...
    return (
        <div className="overflow-auto max-h-96">
            <table className="min-w-full block border-collapse border border-gray-300 bg-white dark:bg-backdrop text-xs">
...
export default DeckRepetitionSummary;
