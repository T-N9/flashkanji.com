...
const LoadingKanjiCard: React.FC = () => {
  ...
  return (
    <div className="relative w-[300px] h-[300px] mx-auto">
        <div
            className={`bg-gradient-to-br !h-full from-black via-slate-800 to-orange-700 relative font-writing-1 text-white p-5 rounded-md card  border-4 shadow-md !cursor-progress`}
        >
            ...
            <p
                className={` text-white absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-9xl animate-pulse`}
            >
                ?
            </p>
        </div>
