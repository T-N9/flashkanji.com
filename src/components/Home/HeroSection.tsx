    ...
    <div className="main-container">
      <div className="grid gap-10 md:gap-16 lg:grid-cols-2">
        <div className="space-y-4 flex flex-col justify-center">
          <h1 className="lg:leading-tighter text-dark dark:text-gray-300 text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl xl:text-[3.4rem] 2xl:text-[3.75rem]">
            Master Kanji with{" "}
            <span className="text-primary">
              <span className="outlined_title tracking-wide dark:!text-slate-800">
                FlashKanji
              </span>
              <br /> フラッシュ漢字
            </span>
