...
interface GeneralState {
  ...
  jukugoDetail: {character : string, hiragana: string, english_meaning : string} | null;
  userInfo: any;
  ...
  setJukugoDetail: (detail: {character : string, hiragana: string, english_meaning : string} | null) => void;
